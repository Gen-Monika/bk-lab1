AVATAR_CHOICES = [
    ...
    ("ciallo/characters/orie.png", "Orie"),
]
...
POST_IMAGE_CHOICES = [
    ("", "No preset image"),
    ("ciallo/characters/nene.png", "Nene"),
    ("ciallo/characters/meguru.png", "Meguru"),
    ("ciallo/characters/noa_2.png", "Noa mini"),
    ("ciallo/characters/nene_sign.jpg", "Please wait"),
    ("ciallo/bg/sky.png", "Blue sky"),
    ("ciallo/bg/beach.png", "Beach"),
    ("ciallo/bg/bgs002.png", "Station"),
]
